...
|   image   |  File  |    O   | <p>이미지 파일(jpg, png)<br>※ 기본</p><p>파일 규격 : JPG, JPEG, PNG만 가능/ 용량 최대 500KB</p><p>권장 사이즈 : 720px X 720px(가로 500px 미만, 가로:세로 비율이 2:1 미만 또는 3:4 초과 시 업로드 불가)</p><p>※ 와이드 </p><p>파일 규격 : JPG, JPEG, PNG만 가능/ 용량 최대 2MB</p><p>사이즈 : 800px X 600px</p> |
| imageType | String |    O   |                                                                                                               이미지 타입(기본=I, 와이드=W)                                                                                                               |
|   title   | String |    O   |                                                                                                                      이미지 제목                                                                                                                     |
|    link   | String |    O   |                                                                                                     이미지 클릭 시 이동할 URL(http:// 또는 https:// 포함)                                                                                                    |
| senderKey | String |    X   |                                                                                            발신프로필키(**입력시** : 해당 발신프로필키에 등록, **미입력시** : 공용(해당계정)으로 등록)                                                                                            |
